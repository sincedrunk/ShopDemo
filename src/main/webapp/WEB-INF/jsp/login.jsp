...
<body>
	<div class="hrader" id="header">
		...
		<a href="reg">注册</a>
		<div class="topNav">
			<a href="index" style="color: #FD7306;">首页</a> <a href="buy">买家</a>
			<a href="sell">卖家</a> <a href="vip">会员中心</a> <a
				href="xuanshang">悬赏榜</a> <a href="luntan" class="luntan">论坛</a>
			<a href="help">帮助</a> <a href="#">&nbsp;</a> <a href="#"
	...
	<div class="mainCont">
		...
		<div class="loginBox">
			<div class="loginLeft">
				<img src="${contextPath}/assets/images/login.jpg" width="567"
					height="348" />
			</div>
			<!--loginLeft/-->
			<div class="loginRight">
				...
				<form class="login" action="${contextPath}/login" method="post">
					...
					<input type="hidden" name="${_csrf.parameterName}"
						value="${_csrf.token}" /> <label>邮箱/用户名/已验证手机</label> <input
					...
					<!--loginSub/-->
					<h2>合作伙伴登录：</h2>
					<img src="${contextPath}/assets/images/hezuo.jpg" width="260"
						height="30" />
				</form>
				<!--login/-->
