	...
	<div class="hrader" id="header">
		...
		<div class="topNav">
			<a href="${contextPath}/index" style="color: #FD7306;">首页</a> <a
				href="${contextPath}/buy">买家</a> <a
				href="${contextPath}/sell">卖家</a> <a
				href="${contextPath}/vip">会员中心</a> <a
				href="${contextPath}/xuanshang">悬赏榜</a> <a
				href="${contextPath}/luntan" class="luntan">论坛</a> <a
				href="${contextPath}/help">帮助</a> <a href="#">&nbsp;</a> <a
	...
	<div class="mainCont">
		...
		<div class="loginBuy">
			<div class="loginBuyLeft">
				...
				<form action="${contextPath}/reg" method="post" class="regForm">
					...
					<div class="loginBuyyan">
						<label for="yanzheng">验证码：</label> <input type="text"
							id="yanzheng" />
						<div class="yanzhengma">
							<img src="${contextPath}/assets/images/yanzheng.jpg" width="124"
								height="52" /> <span>换一张</span>
						</div>
					</div>
					<!--loginBuyList/-->
					<div class="falv">
						<input type="checkbox" /> <span>我已阅读并同意<a
							href="${contextPath}/xieyi" target="_blank">《uniqueZi协议》</a></span>
					</div>
					<!--falv/-->
					<div class="regSubs">
				...
				<form action="#" method="get" class="regForm">
					...
					<!--loginBuyList/-->
					<div class="loginBuyList">
						<label for="pwd">设置密码：</label> <input type="text" id="pwd" />
					</div>
					<!--loginBuyList/-->
					<div class="loginBuyList" style="border: #DEDEDE 1px solid;">
						<label for="pwd1">确认密码：</label> <input type="text" id="pwd1" />
					</div>
					<!--loginBuyList/-->
			...
			<div class="loginBuyRight">
				<div class="regDl">
					<a href="${contextPath}/login"><img
						src="${contextPath}/assets/images/dl.jpg" width="180" height="60" /></a>
					<p>
						已有<a href="${contextPath}/login">供应商</a>账号点击登录！
					</p>
				</div>
				<!--regDl/-->
				<div class="regDl">
					<a href="${contextPath}/login"><img
						src="${contextPath}/assets/images/dl.jpg" width="180" height="60" /></a>
					<p>
						已有<a href="${contextPath}/login">采购商</a>账号点击登录！
					</p>
				</div>
				<!--regDl/-->
			</div>
