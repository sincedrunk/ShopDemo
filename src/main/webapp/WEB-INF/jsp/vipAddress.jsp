...
<body>
	<div class="hrader" id="header">
		<div class="top">
			<a href="login" style="color: #C94E13;">请登录</a> <a href="reg">注册</a>
			<ul class="topNav">
				<li><a href="order">我的订单 </a></li>
				<li class="gouwuche"><a href="car">购物车</a> <strong
	...
	<div class="mid">
		<h1 class="logo" style="text-align: left;">
			<a href="index"><img src="${contextPath}/assets/images/logo.png" width="304"
				height="74" /></a>
		</h1>
		...
		<div class="ding-gou">
			<div class="ding">
				<a href="order"><img src="${contextPath}/assets/images/dingdan.jpg" width="106"
					height="32" /></a>
			</div>
			<!--ding/-->
			<div class="gou">
				<a href="car"><img src="${contextPath}/assets/images/gouwuche.jpg" width="126"
					height="32" /></a>
			</div>
			<!--gou/-->
			<div class="clears"></div>
	...
	<div class="vipBox">
		<div class="vipLeft">
			...
			<dl class="vipNav">
				...
				<dd>
					<a href="vipOrder">我的订单</a>
				</dd>
				<dd>
					<a href="vipShoucang">收藏关注</a>
				</dd>
				...
				<dd>
					<a href="vipPwd">密码修改</a>
				</dd>
				<dd class="ddCur">
					<a href="vipAddress">收货地址</a>
				</dd>
				<dd>
					<a href="vipXiaofei">消费记录</a>
				</dd>
				<dt class="vip_3">客户服务</dt>
				<dd>
					<a href="vipQuxiao">取消订单/退货</a>
				</dd>

				<dd>
					<a href="vipTousu">我的投诉</a>
				</dd>
			</dl>
			<!--vipNav/-->
		</div>
	...
	<div class="footBox">
		<div class="footers">
			<div class="footersLeft">
				<a href="index"><img src="${contextPath}/assets/images/ftlogo.jpg" width="240"
					height="64" /></a>
