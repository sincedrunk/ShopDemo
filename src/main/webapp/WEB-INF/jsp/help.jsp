...
<li><a href="#" class="lan">中文</a></li>
 ...
 <div class="helpBox">
  <div class="helpLeft">
   <ul class="helpNav">
    <li class="helpCur"><a href="#">新手入门</a></li>
    <li><a href="#">购物流程</a></li>
   ...
   <div class="helpPar">
     <ol>
       <li>
         <div>
         <div>
         <a href="#" target="_self"></li>
       <li>
         <div><strong>unique购物流程 文字版<br />
           </strong>第①、去（www.unique.com)注册unique会员，这个不用教吧，有邮箱就行咯，然后去邮箱激活帐号<br />
           第②、去阿里巴巴旗下支付宝网站(www.alipay.com)注册开通支付宝帐号，进入支付宝管理帐户，你要有一张银行卡，并且银行卡要已开通网上电子银行功能,然后就是通过银行卡的验证。<br />
           第③、支付宝会往你银行卡里打点钱，1分到1角之间，你要去查下帐，------这一步是支付宝认证。如果看到你的银行卡有支付宝公司给你打入的开通确认款，说明你的银行卡已绑定支付宝，可以正常使用了。<br />
           第④、现在，可以买东西啦,选好自己喜欢的东西，就跟掌柜联系。问好质量、价格、邮费等等。<br />
           第⑤、购买。点商品页面上立即购买。选择的邮寄方式，还有自己的地址，名字，电话。电话很重要，不然快递会找不到你。<br />
           第⑥、下面可以点付款了。这里付款《掌柜不能拿到钱》，你的钱是打到支付宝那里的，他提不出来。<br />
           第⑦、等掌柜给你发货，你会在我的unique的买到的宝贝里面看到买到的东西，里面状态是已经发货。<br />
           第⑧、收货,在家等快递。收货...再签收。<br />
           第⑨、看看东西是不是和掌柜说的符合，满意的话就去网上确认收货和付款。<br />
           第⑩、最后，千万别忘了给掌柜的好评。同时你也会得到一个买家好评，可以累计的，是别人衡量你信誉度的标准哦<br />
           最后、如果东西有问题或不符合，跟掌柜的提出退款。如果他赖帐，就跟支付宝举报。支付宝会合理处理，把钱还给你。</div>
       </li>
       <li>
         <div></div>
         <div><strong>unique购物流程图</strong><br />
           1、登录www.unique.com，选择您要购买的商品，选中后点&ldquo;立即购买&rdquo;买下您选中的商品：2、正确填写您的收货地址、收货人、联系电话，以方便卖家为您发货后快递公司联系收货人；填写您所需的购买数量；补充完成您的个人基本信息，点&ldquo;确认无误，购买&rdquo;继续：<br />
           3、选择支付宝账户余额支付，输入支付宝账户支付密码，点&ldquo;确认无误，付款&rdquo;，如支付宝账户无余额可以选择网上银行、支付宝卡通、网点付款来完成支付：<br />
           4、支付宝账户余额支付付款成功，点&ldquo;点此查看本笔交易详情&rdquo;：<br />
           5、 卖家发货后，买家注意查收货物，收到货物后，点&ldquo;确认收货&rdquo;付款给卖家：<br />
           6、输入支付宝账户的支付密码，点&ldquo;同意付款&rdquo;付款给卖家：<br />
           7、跳出提示框确认是否真的收到货物，如未收到货物请千万不要点&ldquo;确定&rdquo;按钮，不然可能会钱货二空，收到货请点&ldquo;确定&rdquo;付款给卖家：<br />
           8、成功付款给卖家：<br />
           9、给对方评价：<br />
           10、评价成功：<br />
         </div>
