...
<body>
	...
	<div class="navBox navBg1">
		<ul class="nav">
			...
			<div class="${contextPath}/clears"></div>
		</ul>
		<!--nav/-->
	</div>
	<!--navBox/-->
	...
	<div class="buyinfo">
		<div class="buyDtl">
			<div class="buyDtlLeft">
				<div class="buyimgBig">
					<img src="${contextPath}/assets/images/buyinfo1.jpg" width="360" height="360" /> <img
						src="${contextPath}/assets/images/buyinfo1.jpg" width="360" height="360" /> <img
						src="${contextPath}/assets/images/buyinfo1.jpg" width="360" height="360" /> <img
						src="${contextPath}/assets/images/buyinfo1.jpg" width="360" height="360" /> <img
						src="${contextPath}/assets/images/buyinfo1.jpg" width="360" height="360" />
				</div>
				<!--buyimgBig/-->
			...
			<div class="buyDtlRight">
				...
				<h5>
					价格：<span>￥</span><strong id="price_item_1">1999.00</strong>
				</h5>
				...
				<!--buyTable/-->
				<div class="goumai">
					<a href="${contextPath}/car" class="buy-gou">立即购买</a> <a href="#"
						class="buy-mai">加入购物车</a>
				</div>
				<!--goumai/-->
			</div>
			<!--buyDtlRight/-->
		...
		<div class="buyDtl2">
			...
			<div class="buydlList">
				<table cellpadding="0" cellspacing="1" width="100%" border="0"
					...
					<tr>
						<td class="tdTitle">CPU频率</td>
						<td>2.5GHz</td>
					</tr>
					<tr>
						<td class="tdTitle">CPU核数</td>
						<td>四核</td>
					</tr>
					<tr>
						<td class="tdTitle">运营商标志或内容</td>
						<td>在外包装、在机身、在开机画面、在内置应用</td>
					</tr>
					<tr>
					...
					<tr>
						<td class="tdTitle">网络制式</td>
						<td>移动4G(TD-LTE)-移动3G(TD-SCDMA)-移动2G/联通2G(GSM)</td>
					</tr>
					<tr>
						<td class="tdTitle">网络频率</td>
						<td>TD-LTE(1900/2300/2600) TD-SCDMA(1880/2010) GSM/EDGE/GPRS
							(850/900/1800/1900 MHZ)</td>
					</tr>
					<tr>
						<td class="tdTitle">数据业务</td>
						<td>HSPA + ： 42 / 5.76 Mbps；TD-LTE</td>
					</tr>
					<tr>
					...
					<tr>
						<td class="tdTitle">最大存储扩展</td>
						<td>128GB</td>
					</tr>
					<tr>
						<td class="tdTitle">可用空间</td>
						<td>操作系统和预置应用程序占用部分存储空间,
							因此实际用户可用空间少于存储器标称容量。操作系统或软件版本的更新可能会导致用户可用空间发生变化。</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>1920×1080(FHD,1080P)</td>
					</tr>
					<tr>
						<td class="tdTitle">屏幕材质</td>
						<td>Super AMOLED</td>
					</tr>
					<tr>
						<td class="tdTitle">屏幕色彩</td>
						<td>1600万色</td>
					</tr>
					<tr>
					...
					<tr>
					<tr>
						<td class="tdTitle">摄像头</td>
						<td>1600万像素</td>
					</tr>
					<tr>
						<td class="tdTitle">副摄像头</td>
						<td>200万像素</td>
					</tr>
					<tr>
						<td class="tdTitle">传感器类型</td>
						<td>CMOS</td>
					</tr>
					<tr>
			...
			<!--buydlList/-->
			<div class="buydlList">2</div>
			<!--buydlList/-->
			<div class="buydlList">3</div>
			<!--buydlList/-->
			<div class="buydlList">4</div>
			<!--buydlList/-->
		</div>
		<!--buyDtl2/-->
	</div>
